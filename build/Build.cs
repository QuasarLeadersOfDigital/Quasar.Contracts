...
class Build : NukeBuild
{
	...
	Target Pack => _ => _
		...
		{
			DotNetPack(s => s
				.SetProject(Solution.GetProject("Quasar.Contracts"))
				.SetConfiguration(Configuration)
				.EnableNoBuild()
				.EnableNoRestore()
				.SetDescription("Global Quasar contracts")
				.SetPackageTags("Quasar", "Contracts")
				.SetAuthors("sankovlex@gmail.com")
				.SetPackageProjectUrl("https://github.com/QuasarLeadersOfDigital/Quasar.Contracts")
				.SetPackageLicenseUrl("https://github.com/QuasarLeadersOfDigital/Quasar.Contracts/blob/master/LICENSE")
